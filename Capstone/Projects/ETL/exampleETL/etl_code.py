...
import glob
import pandas as pd
import xml.etree.ElementTree as ET # parse xml file format
from datetime import datetime

# Initialized global variables to hold output of data loadable to a database
...
# Transform Function: required to 
def transform(data): 
